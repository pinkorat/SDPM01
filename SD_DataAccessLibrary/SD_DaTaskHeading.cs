// Generated: Sun Jan 27, 2013 10:54:25
...
namespace SD
{
  ...
  public class DaTaskHeading : DbTaskHeading, ASL.ApplicatFieldType.IDaForm_I
#else
  public class DaTaskHeading : DbTaskHeading
#endif
  {
		#region fetch cache
#if __FETCHCACHE__
		...
		{
      public string TaskHeadingID;
      public int TaskHeadingREF;
		}
		public class FetchEntry
		{
			public int hitCount = 1;
			public DdTaskHeading ddTaskHeading;
			public FetchEntry(DdTaskHeading ddTaskHeading) { this.ddTaskHeading = ddTaskHeading; }
		}
#endif
...
//??Expand _DaFields
    ...
    public string ModifiedBy
    {
      ...
      set 
      { 
        if (value.Length > 50) InvalidateField("Too long", "TaskHeading.ModifiedBy");
#if __REALCHANGE__
    ...
    {
      get { return store.Buffer.ProjectREF; }

      set 
      { 
#if __REALCHANGE__
        if (store.Buffer.ProjectREF != value)
        {
          store.Buffer.ProjectREF = value; 
          store.modProjectREF = true;
        }
#else
        store.Buffer.ProjectREF = value; 
        store.modProjectREF = true;
    ...
    public string TaskHeadingID
    {
      get { return store.Buffer.TaskHeadingID; }

      set 
      { 
        if (value.Length > 200) InvalidateField("Too long", "TaskHeading.TaskHeadingID");
#if __REALCHANGE__
        if (store.Buffer.TaskHeadingID != value)
        {
          store.Buffer.TaskHeadingID = value; 
          store.modTaskHeadingID = true;
        }
#else
        store.Buffer.TaskHeadingID = value; 
        store.modTaskHeadingID = true;
    ...
    public string Title
    {
      ...
      set 
      { 
        if (value.Length > 200) InvalidateField("Too long", "TaskHeading.Title");
#if __REALCHANGE__
    ...
    public SortedList<string, object> GetAsList()
    {
      ...
      items["ProjectREF"] = ProjectREF;
      items["TaskHeadingID"] = TaskHeadingID;
    ...
    public void SetFromList(SortedList<string, object> items)
    {
      ...
      if (items.ContainsKey("ProjectREF")) ProjectREF= (int)items["ProjectREF"];
      if (items.ContainsKey("TaskHeadingID")) TaskHeadingID= (string)items["TaskHeadingID"];
...
#endif
//??EndExpand 1/27/2013 10:54:25 AM
    #endregion fields
    #region form interface
		...
		{
			DnTaskHeading dnTaskHeading = FillByParent(parentREF);
			ArrayList choices = new ArrayList();
			IEnumerator en = dnTaskHeading.GetEnumerator();
			DdTaskHeading ddTaskHeading;
			while (en.MoveNext())
			{
				ddTaskHeading = (DdTaskHeading)en.Current;
				choices.Add(ddTaskHeading.Id.ToString() + "," + ddTaskHeading.Description);
			}
			return choices;
		}
    ...
    private DsTaskHeading store = new DsTaskHeading();

    public DaTaskHeading(SQL.DBConnection dbConnection) : base(dbConnection)
    {
      store.ClearAll();
    }
    ...
    public bool GetByPK(string TaskHeadingID, int TaskHeadingREF)
    {
      store.Buffer.TaskHeadingID = TaskHeadingID;
    ...
    public void SetBuffer(DdTaskHeading buffer)
    {
      store.Buffer = buffer;
    }
    ...
    public DdTaskHeading GetBuffer()
    {
      return store.Buffer; 
    }
    ...
    #region fetch cache
#if __FETCHCACHE__
		public bool FetchByPK(string TaskHeadingID, int TaskHeadingREF)
		{
			if (fetchTable == null)
			{
      ...
      store.Buffer.TaskHeadingREF = TaskHeadingREF;
		...
		#region extend
		public DnTaskHeading Fill()
		{
			string sqlWhere = "Id >= 100";
			return Fill(sqlWhere, "TaskHeadingID", 0, true);
		}
		public DnTaskHeading FillByProject(int parentREF)
		{
			string sqlWhere = string.Format("ProjectREF={0}", parentREF);
			return Fill(sqlWhere, "TaskHeadingID", 0, true);
		}
		#endregion extend
  }
  ...
  public class DbTaskHeading : ASL.SQL.TableDataObject
  {
    ...
    private const int idxProjectREF = 5;
    private const int idxTaskHeadingID = 6;
    ...
    static readonly protected string[] sqlCols =
    {
     ...
     , "[ProjectREF]", "[TaskHeadingID]", "[TaskHeadingREF]", "[Timestamp]"
     , "[Title]"
    };
    ...
    public DbTaskHeading(SQL.DBConnection dbConnection)
    {
      base.dbConnection = dbConnection;
      tableName = "TaskHeading";
    ...
    public bool GetById(int Id, out DdTaskHeading buffer)
    {
      DsTaskHeading dsTaskHeading = new DsTaskHeading();
      dsTaskHeading.Buffer.Id = Id;
      if (!GetById(ref dsTaskHeading)) 
      {
        buffer = new DdTaskHeading();
        return false;
      }
      buffer = dsTaskHeading.Buffer;
      return true;
    }

    public bool GetById(ref DsTaskHeading xStr)
    {
    ...
    public bool GetByPK(
        string TaskHeadingID
      , int TaskHeadingREF
      , out DdTaskHeading buffer)
    {
      DsTaskHeading dsTaskHeading = new DsTaskHeading();
      dsTaskHeading.Buffer.TaskHeadingID = TaskHeadingID;
      dsTaskHeading.Buffer.TaskHeadingREF = TaskHeadingREF;
      if (!GetByPK(ref dsTaskHeading))
      {
        buffer = new DdTaskHeading();
        return false;
      }
    ...
    public bool GetByPK(ref DsTaskHeading xStr)
    {
      string sql = "SELECT " + sqlColumns
      + " FROM " + tableName + NOLOCKSQL
      + " WHERE TaskHeadingID = " + TXT.q1(xStr.Buffer.TaskHeadingID)
    ...
    public bool UpdateById(ref DsTaskHeading xStr)
    {
      int rowsUpdated = 0;
      if (xStr.Modified())
      {
    ...
    public bool UpdateByPK(ref DsTaskHeading xStr)
    {
      int rowsUpdated = 0;
      if (xStr.Modified())
      {
        string sql = "UPDATE " + tableName + " SET " + BuildUpdateSQL(xStr) + " WHERE"
      + " TaskHeadingID = " + TXT.q1(xStr.Buffer.TaskHeadingID)
      + " AND TaskHeadingREF = " + xStr.Buffer.TaskHeadingREF.ToString();
        if(!UpdateSQL(sql)) return false;
        rowsUpdated = _rowsAffected;
      }
      ...
      , int TaskHeadingREF)
    {
      ...
      + " TaskHeadingID = " + TXT.q1(TaskHeadingID)
      + " AND TaskHeadingREF = " + TaskHeadingREF.ToString();
      return DeleteSQL(sql);
    }

    public bool DeleteByPK(ref DsTaskHeading xStr)
    {
      string sql = "DELETE FROM " + tableName + " WHERE"
      + " TaskHeadingID = " + TXT.q1(xStr.Buffer.TaskHeadingID)
      + " AND TaskHeadingREF = " + xStr.Buffer.TaskHeadingREF.ToString();
    ...
    public bool Insert(ref DsTaskHeading xStr)
    {
      int Id;
    ...
    public bool GetBySql(string sqlWhere, ref DsTaskHeading xStr)
    {
      string sql = "SELECT " + sqlColumns
    ...
    public DnTaskHeading Fill(string xWhere, string xOrder, int xTop, bool xNoLock)
    {
      System.Data.DataTable dt = FillDataTable(xWhere, xOrder, xTop, xNoLock);
      DnTaskHeading TaskHeadingList = new DnTaskHeading(dt.Rows.Count);
      foreach(System.Data.DataRow adr in dt.Rows)
      {
        TaskHeadingList.Add(Load(adr).Buffer);
      }
      return TaskHeadingList;
    }

    static public DsTaskHeading Load(System.Data.DataRow dr)
    {
      DsTaskHeading tStr = new DsTaskHeading();
      tStr.ClearBuffer();
      ...
      if (dr[idxProjectREF] != System.DBNull.Value) tStr.Buffer.ProjectREF = (int)dr[idxProjectREF];
      if (dr[idxTaskHeadingID] != System.DBNull.Value) tStr.Buffer.TaskHeadingID = (string)dr[idxTaskHeadingID];
    ...
    public string BuildInsertSQL(DsTaskHeading xStr)
    {
      ...
      if (xStr.modProjectREF)
        sc.AddColumn(sqlCols[idxProjectREF], xStr.Buffer.ProjectREF);
      if (xStr.modTaskHeadingID)
        sc.AddColumn(sqlCols[idxTaskHeadingID], xStr.Buffer.TaskHeadingID);
    ...
    public string BuildUpdateSQL(DsTaskHeading xStr)
    {
    ...
    //  Index = IX_TaskHeading
    public bool GetBy_IX_TaskHeading(
      string TaskHeadingID
    , int TaskHeadingREF
    , out DdTaskHeading buffer)
  {
    string sql = "SELECT " + sqlColumns
    + " FROM " + tableName + NOLOCKSQL
    + " WHERE TaskHeadingID = " + TXT.q1(TaskHeadingID)
    + " AND TaskHeadingREF = " + TaskHeadingREF.ToString();
    System.Data.DataRow dr;
    if (GetSQL(sql, out dr))
    {
      DsTaskHeading dsTaskHeading = Load(dr);
      buffer = dsTaskHeading.Buffer;
      return true;
    }
    else
    ...
    // Reader
		...
		static public DdTaskHeading LoadRow(System.Data.SqlClient.SqlDataReader reader)
		{
			DdTaskHeading rowBuffer = new DdTaskHeading();
			rowBuffer.Clear();
			...
			if (!reader.IsDBNull(idxProjectREF)) rowBuffer.ProjectREF = reader.GetInt32(idxProjectREF);
			if (!reader.IsDBNull(idxTaskHeadingID)) rowBuffer.TaskHeadingID = reader.GetString(idxTaskHeadingID);
  ...
  [Serializable]
  public class DsTaskHeading
  {
    public DdTaskHeading Buffer = new DdTaskHeading();
    ...
    public bool modProjectREF;
    public bool modTaskHeadingID;
  ...
  [Serializable]
  public class DdTaskHeading : ASL.Forms.DdBase
  {
    public string Description { get; set; }
    public int ProjectREF { get; set; }
    public string TaskHeadingID { get; set; }
    public int TaskHeadingREF { get; set; }
    public string Title { get; set; }

    public const string Description_N = "Description";
    public const string ProjectREF_N = "ProjectREF";
    public const string TaskHeadingID_N = "TaskHeadingID";
    public const string TaskHeadingREF_N = "TaskHeadingREF";
    public const string Title_N = "Title";

    public const int Description_L = -1;
    public const int TaskHeadingID_L = 200;
    public const int Title_L = 200;

    public DdTaskHeading()
	  : base()
    {
      Clear();
    }

    public DdTaskHeading(DdTaskHeading original)
	  : base(original)
    {
      Description = original.Description;
      ProjectREF = original.ProjectREF;
      TaskHeadingID = original.TaskHeadingID;
  ...
  [Serializable]
  public class DnTaskHeading : System.Collections.Generic.List<DdTaskHeading>
  {
    public DnTaskHeading() : base() {}
    public DnTaskHeading(int xCapacity) : base(xCapacity) {}

    public new DdTaskHeading this[int xIndex]
    {
      get { return (DdTaskHeading) base[xIndex]; }
